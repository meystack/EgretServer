...
//新实体类型定义
#define MAX_ROLE 3
#define MAX_ACTOR_LEVEL 999  //玩家的最大等级
#define ZHUAN_SHENG_BASE_LEVEL 50	// 转生基础等级
...
enum CurrencyType
{
	...
	NumericType_DianQuan = 100,//点券
	NumericType_Quota = 101,//交易额度
};
...
enum RankingType
{
	...
	RankingType_Level,//5
	RankingType_Wing,//6
	RankingType_Warrior,//7
	RankingType_Mage,//8
	RankingType_Taoistpriest,
	RankingType_Train,
	RankingType_TianTi,
