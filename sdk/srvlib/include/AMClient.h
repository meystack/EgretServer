...
public:
	...
	static const char * GetOpCode(int nOp)
	{
		switch(nOp)
		{
		case amQueryAmount:
	...
	* @Return VOID:
	*/
	VOID PostConsume(unsigned int nUserId, INT_PTR nServerId, INT_PTR nAmount, LPCSTR sCharName, INT64 lOPPtr);
...
private:
	...
	VOID flushSendPacket(CDataPacket& packet);
private:
